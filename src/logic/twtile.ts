...
export const TWtoCC = Object.freeze({
  [TW.Empty]: CC.FLOOR.code,

  [TW.Slide_North]: CC.FORCE_N.code,
  [TW.Slide_West]: CC.FORCE_W.code,
  [TW.Slide_South]: CC.FORCE_S.code,
  [TW.Slide_East]: CC.FORCE_E.code,
  [TW.Slide_Random]: CC.FORCE_RANDOM.code,
  [TW.Ice]: CC.ICE.code,
  [TW.IceWall_Northwest]: CC.ICE_NW.code,
  [TW.IceWall_Northeast]: CC.ICE_NE.code,
  [TW.IceWall_Southwest]: CC.ICE_SW.code,
  [TW.IceWall_Southeast]: CC.ICE_SE.code,
  [TW.Gravel]: CC.GRAVEL.code,
  [TW.Dirt]: CC.DIRT.code,
  [TW.Water]: CC.WATER.code,
  [TW.Fire]: CC.FIRE.code,
  [TW.Bomb]: CC.BOMB.code,
  [TW.Beartrap]: CC.TRAP.code,
  [TW.Burglar]: CC.THIEF.code,
  [TW.HintButton]: CC.HINT.code,

  [TW.Button_Blue]: CC.BLUE_BUTTON.code,
  [TW.Button_Green]: CC.GREEN_BUTTON.code,
  [TW.Button_Red]: CC.RED_BUTTON.code,
  [TW.Button_Brown]: CC.BROWN_BUTTON.code,
  [TW.Teleport]: CC.TELEPORT.code,

  [TW.Wall]: CC.WALL.code,
  [TW.Wall_North]: CC.THIN_WALL_N.code,
  [TW.Wall_West]: CC.THIN_WALL_W.code,
  [TW.Wall_South]: CC.THIN_WALL_S.code,
  [TW.Wall_East]: CC.THIN_WALL_E.code,
  [TW.Wall_Southeast]: CC.THIN_WALL_SE.code,
  [TW.HiddenWall_Perm]: CC.INVISIBLE_WALL.code,
  [TW.HiddenWall_Temp]: CC.APPEARING_WALL.code,
  [TW.BlueWall_Real]: CC.BLUE_BLOCK_WALL.code,
  [TW.BlueWall_Fake]: CC.BLUE_BLOCK_FLOOR.code,
  [TW.SwitchWall_Open]: CC.TOGGLE_WALL_OPEN.code,
  [TW.SwitchWall_Closed]: CC.TOGGLE_WALL_CLOSED.code,
  [TW.PopupWall]: CC.POPUP_WALL.code,

  [TW.CloneMachine]: CC.CLONE_MACHINE.code,

  [TW.Door_Red]: CC.RED_DOOR.code,
  [TW.Door_Blue]: CC.BLUE_DOOR.code,
  [TW.Door_Yellow]: CC.YELLOW_DOOR.code,
  [TW.Door_Green]: CC.GREEN_DOOR.code,
  [TW.Socket]: CC.SOCKET.code,
  [TW.Exit]: CC.EXIT.code,

  [TW.ICChip]: CC.COMPUTER_CHIP.code,
  [TW.Key_Red]: CC.RED_KEY.code,
  [TW.Key_Blue]: CC.BLUE_KEY.code,
  [TW.Key_Yellow]: CC.YELLOW_KEY.code,
  [TW.Key_Green]: CC.GREEN_KEY.code,
  [TW.Boots_Ice]: CC.ICE_SKATES.code,
  [TW.Boots_Slide]: CC.SUCTION_BOOTS.code,
  [TW.Boots_Fire]: CC.FIRE_BOOTS.code,
  [TW.Boots_Water]: CC.FLIPPERS.code,

  [TW.Block_Static]: CC.BLOCK.code,

  [TW.Drowned_Chip]: CC.DROWNING_CHIP.code,
  [TW.Burned_Chip]: CC.BURNED_CHIP.code,
  [TW.Bombed_Chip]: CC.BURNED_CHIP2.code,
  [TW.Exited_Chip]: CC.CHIP_IN_EXIT.code,
  [TW.Exit_Extra_1]: CC.EXIT_END_GAME.code,
  [TW.Exit_Extra_2]: CC.EXIT_END_GAME2.code,

  [TW.Overlay_Buffer]: -1,

  [TW.Floor_Reserved2]: CC.UNUSED2.code,
  [TW.Floor_Reserved1]: CC.UNUSED1.code,

  [TW.Chip]: CC.CHIP_N.code,

  [TW.Block]: CC.BLOCK.code,

  [TW.Tank]: CC.TANK_N.code,
  [TW.Ball]: CC.BALL_N.code,
  [TW.Glider]: CC.GLIDER_N.code,
  [TW.Fireball]: CC.FIREBALL_N.code,
  [TW.Walker]: CC.WALKER_N.code,
  [TW.Blob]: CC.BLOB_N.code,
  [TW.Teeth]: CC.TEETH_N.code,
  [TW.Bug]: CC.BUG_N.code,
  [TW.Paramecium]: CC.PARAMECIUM_N.code,

  [TW.Swimming_Chip]: CC.CHIP_SWIMMING_N.code,
  [TW.Pushing_Chip]: CC.CHIP_N.code, // TODO
