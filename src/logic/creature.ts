...
import { TW, CCtoTW } from './twtile';
import { layerIndexForPoint } from '../util/utils';
// import { Dir } from "./dir";
...
export class Creature {
  ...
  decKeyFor(twtile: number) {
    switch (twtile) {
      case TW.Door_Red:     if (this.numRedKeys > 0) this.numRedKeys -= 1; break;
      case TW.Door_Blue:    if (this.numBlueKeys > 0) this.numBlueKeys -= 1; break;
      case TW.Door_Yellow:  if (this.numYellowKeys > 0) this.numYellowKeys -= 1; break;
  ...
  incKeyFor(twtile: number) {
    ...
    switch (twtile) {
      case TW.Key_Red:    this.numRedKeys += 1; if (this.numRedKeys > 255) this.numRedKeys = 0; break;
      case TW.Key_Blue:   this.numBlueKeys += 1; if (this.numRedKeys > 255) this.numRedKeys = 0; break;
      case TW.Key_Yellow: this.numYellowKeys += 1; if (this.numRedKeys > 255) this.numRedKeys = 0; break;
      case TW.Key_Green:  this.numGreenKeys += 1; if (this.numGreenKeys > 255) this.numGreenKeys = 0; break;
      default:
    }
  }
